...
public:
  ...
  struct MatchFinderOptions {
    ...
    /// etc.) and only when the source location is valid, so the
    /// translation-unit root is never skipped.
    ///
    /// \note This is a best-effort pruning mechanism. Matchers that
    /// recursively visit children of an in-scope node (e.g.
