...
private:
  ...
  /// Returns the cached header filter matcher for the current options.
  HeaderFilterMatcher &getHeaderFilterMatcher();
  ...
  std::unique_ptr<HeaderFilterMatcher> HeaderFilterMatchHelper;
