...
// RUN: cd "%t-matching"
// RUN: not %run_clang_tidy -j 1 -header-filter=does-not-match "test.cpp" 2>&1 | FileCheck %s --check-prefix=CHECK-SCOPING-UNSAFE
// CHECK-SCOPING-UNSAFE: 'lO' is confusable with 'l0'
